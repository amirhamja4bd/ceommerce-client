...
// console.log("product",product)
    ...
    const loadProduct = async () => {
        ...
        const token = localStorage.getItem('token');
          const { data } = await axios.get(`/product/${params.slug}`, { headers: { Authorization: token } });
          setProduct(data);
            ...
            <div className="container">
                    ...
                    <div className="row p-4 d-flex align-items-center">
                        ...
                        <div className="col-md-7 ">
                            ...
                            <div className="d-flex w-50">
                                <p className=" text-success rounded me-5">{`${product?.quantity >= 1 ? `${product?.quantity - product?.sold} in stock` : "Out of stock" }`}</p>
                            </div>
                ...
                <nav className='mt-5 bg-light'>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" aria-controls="nav-review" aria-selected="false">Ratings and Reviews</button>
                    </div>
                </nav>
                            ...
                            {review?.length ? (
                                <div className=" p-3">
                                    <h4>Ratings & Reviews of {product?.title}</h4>
                                        <a className='mt-0' href="">{review?.length} Reviews</a>
