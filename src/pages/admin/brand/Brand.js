            ...
            <div className="me-3">
                ...
                <div className="col-md-9">
                    <div className="row">
                            ...
                            <table class="table ">
                                ...
                                <tbody>
                                    ...
                                    <tr key={b?._id}>
                                        ...
                                        <td>{b?.name}</td>
                                        <td>
                                            <button  onClick={updateBrand.bind(this, b?.slug)} className='btn btn-primary me-2'><i class="fa-solid fa-pen-to-square"></i></button>
                                            <button  onClick={handleDelete.bind(this, b?._id)} className='btn btn-danger'><i class="fa-regular fa-trash-can"></i></button>
                        ...
                        <div className="p-3 mt-2 mb-2 h4 bg-light">Create Brand</div>
